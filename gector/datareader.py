...
class Seq2LabelsDatasetReader(DatasetReader):
    ...
    def _read(self, file_path):
        ...
        with open(file_path, "r") as data_file:
            ...
            for line in data_file:
                ...
                tokens_and_tags = [
                    pair.rsplit(self._delimeters['labels'], 1) for pair in line.split(self._delimeters['tokens'])
                ]
                try:
    ...
    def text_to_instance(
        self, tokens: List[Token], tags: List[str] = None, words: List[str] = None
        ...
        if tags is not None:
            ...
            fields["labels"] = SequenceLabelField(labels, sequence, label_namespace="labels")
